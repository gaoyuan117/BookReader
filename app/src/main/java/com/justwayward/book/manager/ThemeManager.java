...
//    public static Bitmap getThemeDrawable(int theme,String change) {
//        if(!TextUtils.isEmpty(change)){
//            ReaderApplication.bmp.recycle();
//            ReaderApplication.bmp = null;
//            ReaderApplication.bmp =Bitmap.createBitmap(ScreenUtils.getScreenWidth(), ScreenUtils.getScreenHeight(), Bitmap.Config.ARGB_8888);
//            bmp = ReaderApplication.bmp;
//        }
