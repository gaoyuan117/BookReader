        ...
        return new BaseViewHolder<SearchBean.DataBean>(parent, R.layout.item_search_result_list) {
            ...
            public void setData(SearchBean.DataBean item) {
                holder.setRoundImageUrl(R.id.ivBookCover, item.getPic(), R.drawable.cover_default)
                        ...
                        .setText(R.id.tvLatelyFollower, String.format(mContext.getString(R.string.search_result_lately_follower), item.getView_num()))
                        .setText(R.id.tvRetentionRatio, (TextUtils.isEmpty(item.getCollect_num()+"") ? String.format(mContext.getString(R.string.search_result_retention_ratio), "0")
                                : String.format(mContext.getString(R.string.search_result_retention_ratio), item.getCollect_num()+"")))
